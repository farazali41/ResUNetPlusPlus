...
if __name__ == '__main__':
    ...
    train1_images, train_images = train_test_split(train_images, test_size=test_size, random_state=42)
    train1_masks, train_masks = train_test_split(train_masks, test_size=test_size, random_state=42)
